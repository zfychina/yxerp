...
<!--          {{data.sku.order.supplier?.shortname}}-->
          {{data.order.supplier?.shortname || data.order.customer || data.sku.order.supplier?.shortname}}
<!--          {{data.order.customer?.shortname}}-->
<!--          {{}}-->
        </p>
        <span style="color: var(--color-red);font-size: 7px;">{{data.sku.order ? data.sku.order.order : ''}}</span>
      </span>
    </van-col>

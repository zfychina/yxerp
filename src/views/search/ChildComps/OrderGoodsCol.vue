...
<!--    </van-col>-->
    ...
    <van-col span="4">
      <span style="line-height: 3; font-size: 12px; text-align: left;"><p>{{data.quantity}}{{" " + data.sku.unit.name}}</p></span>
      <span style="line-height: 0.5; font-size: 8px; color: var(--color-border); text-align: left;">
        <p>{{data.order.customer.shortname}}</p>

...
<!--    </van-col>-->
    ...
    <van-col span="4">
      <span style="line-height: 3; font-size: 10px; text-align: left;"><p>{{data.quantity + " "}}{{data.sku.sku ? data.sku.sku.unit.name : data.sku.unit.name}}</p></span>
      <span style="line-height: 0.5; font-size: 8px; color: var(--color-border); text-align: left;">
        <p>

...
<!--                详情-->
                <category-goods  v-if="category_flag && state.categorydata?.[state.tabtitle[active]]" :data="sortBykey(state.categorydata?.[state.tabtitle[active]], 'quantity')"></category-goods>
              </van-list>

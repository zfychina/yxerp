<template>
  <van-sticky>
    <van-nav-bar title="客户统计" left-arrow :border='false' fixed @click-left="onClickLeft">
    </van-nav-bar>
  </van-sticky>
...
import {getYearcugoodsReport} from "network/statement";
...
export default {
  ...
  setup(){
    ...
    const getyeardata=() =>{
      getYearcugoodsReport('year').then(res=>{
        console.log(res);
    ...
    const getcategorydata=() =>{
      getYearcugoodsReport('category').then(res=>{
        console.log(res);

<template>
  ...
  <!--展开显示订单商品  1 -->
  <table-goods-bom-one v-show="is_spread" v-for="(goodsdata,index) in state.goodslist" :key="index" :goodsdata="goodsdata" @spreadbomone="spreadbomone"></table-goods-bom-one>
...
import TableGoodsBomOne from "components/common/TableGoodsBomOne";

export default {
  name: "TableGoodsBom",
  components: {TableGoodsBomOne},
  props: {
    goodsdata: {
      type: Array,
      default() {

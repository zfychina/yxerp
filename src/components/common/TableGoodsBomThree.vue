<template>
  ...
  <!--展开显示订单商品 3 -->
  <table-goods-bom-four v-show="is_spread" v-for="(goodsdata,index) in state.goodslist" :key="index" :goodsdata="goodsdata" @spreadbomone="spreadbomone"></table-goods-bom-four>
...
import TableGoodsBomFour from "./TableGoodsBomFour";

export default {
  name: "TableGoodsBomThree",
  components: {TableGoodsBomFour},
  props: {
    goodsdata: {
      type: Array,
      default() {

<template>
  ...
  <van-row justify="left" style="font-size: 12px" align="center">
    <van-col offset="4" span="1" style="vertical-align: middle;"></van-col>
    <van-col  span="8">
  ...
  <!--展开显示订单商品  4 -->
  <table-goods-bom-five v-show="is_spread" v-for="(goodsdata,index) in state.goodslist" :key="index" :goodsdata="goodsdata" @spreadbomone="spreadbomone"></table-goods-bom-five>

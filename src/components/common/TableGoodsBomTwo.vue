<template>
  ...
  <van-row justify="left" style="font-size: 12px" align="center">
    <van-col offset="3" span="1" style="vertical-align: middle;"></van-col>
    <van-col  span="9">
  ...
  <!--展开显示订单商品  2 -->
  <table-goods-bom-three v-show="is_spread" v-for="(goodsdata,index) in state.goodslist" :key="index" :goodsdata="goodsdata" @spreadbomone="spreadbomone"></table-goods-bom-three>
...
import TableGoodsBomThree from "./TableGoodsBomThree";

export default {
  name: "TableGoodsBomTwo",
  components: {TableGoodsBomThree},
  props: {
    goodsdata: {
      type: Array,
      default() {

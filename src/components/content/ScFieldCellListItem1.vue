<template>
  ...
  <div v-show="is_spread" >
    <sc-field-cell-list-item2 v-for="(goodsdata,index) in state.goodslist"  @inputvalue="receiveskulistvalue" :key="index" :serial="index" :data="goodsdata" @spreadbomone="spreadbomone"></sc-field-cell-list-item2>
  </div>
...
export default {
  ...
  components: {ScFieldCellListItem2, AutoCell, AutoCellGood},
  props: {
    quantity: {
      type: Number,
    },

<template>
  ...
  <!--展开显示订单商品  1 -->
  <sc-field-cell-list-item3 v-show="is_spread" v-for="(goodsdata,index) in state.goodslist" :key="index" :serial="index" :data="goodsdata" @spreadbomone="spreadbomone"></sc-field-cell-list-item3>
...
export default {
  ...
  components: { AutoCell, AutoCellGood, ScFieldCellListItem3},
  props: {
    quantity: {
      type: Number,
    },
